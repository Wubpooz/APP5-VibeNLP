...
**Duration**: 60 minutes
**Level**: Intermediate
**Prerequisites**: Completed TP1 and TP2, basic understanding of AI agents and LLMs
...
## Part 1: The Birth of Clawdbot (15 minutes)
...
### Exercise 1.1: Research the Original Project

Visit the OpenClaw GitHub repository and answer the following questions:

**Questions**:
1. What programming language(s) is the project written in?
2. What messaging platforms are supported?
3. How does the agent architecture work?
...
## Part 2: The Trademark Issue (10 minutes)
...
## Part 3: Claude Code vs Moltbot (15 minutes)

### Key Differences

| Feature | Claude Code | Moltbot (OpenClaw) |
|--------------------------|-------------|-------------------|
...
### Exercise 3.1: Comparison Analysis

Create a short document (200-300 words) explaining which tool you would choose for:
...
## Part 4: Moltbook - The AI Social Network (15 minutes)
...
### Exercise 4.1: Observe Moltbook

Visit Moltbook and observe AI agent interactions for 10-15 minutes. Note:
...
**Resource**: Search for "Moltbook AI social network" to find the platform.

---

## Part 5: Ethical Considerations (5 minutes)
...
- Understanding of the Clawdbot → Moltbot → Moltbook evolution
- Ability to compare Claude Code and Moltbot
- Hands-on observation of AI agent interactions
- Critical thinking about AI ethics and autonomy
- Understanding of trademark considerations in AI projects
...
1. **Research Document** (Exercise 1.1):
   - Answers to the three research questions about OpenClaw

2. **Discussion Responses** (Part 2):
   - Your thoughts on the trademark discussion questions (150-200 words)

3. **Comparison Document** (Exercise 3.1):
   - Your analysis of when to use Claude Code vs Moltbot

4. **Moltbook Observation Report** (Exercise 4.1):
   - Your notes from observing Moltbook AI interactions

5. **Reflection** (200-300 words):
   - What do you think the future holds for AI agents and AI-only spaces? How might this affect software development and human-AI collaboration?
