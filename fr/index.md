...
1. **Présentation de projet NLP** (Demo Day) : 31 mars, voir [Règles du Demo Day]({{ site.baseurl }}/fr/demo-day/)
2. **Présentations de partage de connaissances en groupe** : 9-20 mars, voir [Règles des présentations]({{ site.baseurl }}/fr/presentation/)
