---
title: "Group Knowledge Sharing Presentations"
ref: presentation
---

## Overview

- **Dates**: March 9 - March 20, 2026 (4 sessions)
- **Format**: Group presentations, 20 minutes per group
- **Topics**: 4, with increasing difficulty
...
The following are reference directions, not a checklist to cover exhaustively. Each group should choose their focus based on their own understanding — depth matters more than breadth.

### Topic #1: Startup Toolbox (09/03)

Preparing for the Demo Day NLP project, sharing practical tools and experience:

- Project management (e.g., Linear, GitHub Projects)
- Getting free LLM API tokens
- Vibe Coding tools
...
- OpenClaw configuration and usage
...
This is not a traditional academic presentation — it is a **knowledge sharing and learning reflection** exercise.

| Dimension | Description | Weight |
|-----------|-------------|--------|
| Knowledge Transfer | Did the audience actually learn something? | 40% |
| Learning Process & Methods | Did the group show how they learned the topic? (AI tools used, peer discussions, challenges encountered) | 40% |
| Presentation Quality | Clear delivery, good structure, time kept within 20 minutes | 20% |
